...
function FinalCTA() {
  return (
    <section className="afl-sect afl-final">
      <div className="afl-body">
        <div>
          <h2>Заведите<br /><span className="ghost">первый проект</span></h2>
        </div>
        <div>
          <p className="body">
            Один живой проект. Пригласите заказчика, зафиксируйте визит на объекте. Если через две недели не увидите разницы — просто закройте вкладку. Доступ бесплатный, ничего возвращать не нужно.
          </p>
          <a href="/login?mode=register" className="afl-btn">Создать аккаунт →</a>
