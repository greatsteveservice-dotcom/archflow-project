...
export default function PrivacyPage() {
  return (
    <div style={S.wrap}>
      ...
      <ul style={S.ul}>
        <li style={S.li}>— Данные хранятся на серверах Supabase (EU region) с шифрованием в покое (AES-256) и при передаче (TLS 1.3)</li>
      ...
      <ul style={S.ul}>
        <li style={S.li}>— Инфраструктурных провайдеров (Supabase, Netlify, Resend) — только в объёме необходимом для работы сервиса, на условиях конфиденциальности</li>
